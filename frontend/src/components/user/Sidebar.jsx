...
const UserSidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const menuItems = [
    ...
    { icon: Search, label: 'Job Search', path: '/user/jobsearch' },
    { icon: FileText, label: 'Applications', path: '/user/applications' },
    { icon: Bookmark, label: 'Saved Jobs', path: '/user/saved-jobs' },
    { 
      icon: Bell, 
      label: 'Notifications', 
      ...
      `}>
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-lg font-bold text-gray-800">RojgariHub</span>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
